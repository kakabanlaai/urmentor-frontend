      ...
      <div className="-mx-4 my-10 flex flex-wrap ">
        {mentors.map((mentor) => (
          <div className="w-full px-4 md:w-1/2 lg:w-1/3 xl:w-1/4">
            <div className="mb-8 w-full rounded-lg bg-white text-gray-900 shadow-xl ">
              ...
              <div className="relative mx-auto -mt-16 h-32 w-32 overflow-hidden rounded-full border-4 border-white">
                <img
                  ...
                  src="https://utfs.io/f/33460bc3-a6f2-44df-89de-57522b00d212-97k0em.jpg"
